...
subroutine chooseFourierModes()
  ...
  PetscScalar, dimension(:,:), allocatable :: patternWithExpectedSpectrum
  PetscScalar, dimension(:), allocatable :: FourierVector, amplitudes
...
!!$  end do
  ...
  call dmrgrnk(amplitudes,permutation)
