...
discretizationParameters = struct(...
    ...
    'xi_pentadiagonal_terms_option', 1, ...
    'include_streaming_xi_tridiagonal_terms', true, ...
    'piecewise_upwinding',false, ...
    'preconditioner_alpha_min_L',Inf);
