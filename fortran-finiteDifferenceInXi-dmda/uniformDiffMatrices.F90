...
subroutine uniformDiffMatrices(N, xMin, xMax, scheme, x, weights, ddx, d2dx2)
  ...
  PetscReal, intent(in) :: xMin, xMax
  PetscReal, intent(out), dimension(N) :: x, weights
  PetscReal, intent(out), dimension(N,N) :: ddx, d2dx2
  integer :: i
  PetscReal :: dx, dx2
  PetscReal :: h
  integer :: n1, n2
  PetscReal, allocatable :: topc(:), col1(:)
  PetscReal, parameter :: pi = 3.1415926535897932384626433d+0
