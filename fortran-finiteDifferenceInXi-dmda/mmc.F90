...
!#include <finclude/petscdmda.h>
  ...
  call PetscOptionsGetBool(PETSC_NULL_CHARACTER, '-upwindInPCOnly', upwindInPCOnly, wasSet, ierr)
  ...
  if (masterProc) then
     ...
     if (upwindInPCOnly) then 
        print *,"upwindInPCOnly = true"
     else
        print *,"upwindInPCOnly = false"
     end if
  end if
